...
public class FactoryProperties {
    ...
    public static void readInfo() throws IllegalArgumentException {
        try (BufferedReader file = new BufferedReader(new FileReader("src/main/resources/ru/nsu/ccfit/usoltsev/carfactory/FactoryProperties"))) {
            String line;
            ...
            if (ENGINE_STORAGE_SIZE == 0 || BODY_STORAGE_SIZE == 0 || ACCESSORY_STORAGE_SIZE == 0 || NUMBER_OF_WORKERS == 0) {
                throw new IllegalArgumentException("Bad data");
            }
        } catch (IOException e) {
